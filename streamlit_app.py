...
""",
    ...
    if st.session_state.vector_db is not None:
        ...
        # --- ENFORCED STRUCTURED THINKING & PHRASING SYSTEM INSTRUCTION ---
        sys_instruction = (
            ...
            "CRITICAL FORMATTING RULE: Formulate and structure your response into these exact sections: "
            "1. A clear, 1-sentence overview statement. "
            "2. Detailed breakdown points using clean bullet points. "
            "3. A final bolded takeaway statement summarizing the core insight."
        )
        # -----------------------------------------------------------------
        ...
        sys_instruction = (
            "You are APOLLO OMNI AI, an advanced study assistant. "
            "CRITICAL FORMATTING RULE: Answer using general knowledge by structuring your response into: "
            "1. A clear overview. "
            "2. Bulleted key breakdown points. "
            "3. A concise final takeaway."
        )
